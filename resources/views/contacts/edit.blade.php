    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center my-5">
                ...
                <h2 class="text-muted">Modifier le contact {{ $contact->name }}</h2>
            </div>
            <div class="col-xs-12 col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-block">
                        <h4 class="text-center my-3">Modifier un contact</h4>

                        <div class="col-xs-12 col-xl-8 offset-xl-2">
                            <form method="POST" action="{{ url("/contacts/{$contact->id}") }}" role="form">
                                {{ method_field('PUT') }}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                           value="{{ $contact->name }}" placeholder="Nom du contact" required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group{{ $errors->has('address_line1') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="address_line1" name="address_line1" class="form-control"
                                           value="{{ $contact->address_line1 }}" placeholder="Rue n°" required>
                                ...
                                <div class="form-group{{ $errors->has('address_line2') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="address_line2" name="address_line2" class="form-control"
                                           value="{{ $contact->address_line2 }}" placeholder="Appartement, suite">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-4{{ $errors->has('zip') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" id="zip" name="zip" class="form-control"
                                               value="{{ $contact->zip }}" placeholder="e.g. 1002" required>
                                        @if ($errors->has('zip'))
                                            <span class="help-block">
                                    ...
                                    <div class="col-xs-12 col-sm-8{{ $errors->has('city') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" id="city" name="city" class="form-control"
                                               value="{{ $contact->city }}" placeholder="e.g. Lausanne" required>
                                        @if ($errors->has('city'))
                                            <span class="help-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" id="phone_number" name="phone_number" class="form-control"
                                               value="{{ $contact->phone_number }}" placeholder="e.g. +41 (0)12 345 67 89">
                                    ...
                                    <div class="col-xs-12 col-sm-6{{ $errors->has('fax') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" id="fax" name="fax" class="form-control"
                                               value="{{ $contact->fax }}" placeholder="e.g. +41 (0)12 345 67 90">
                                        @if ($errors->has('fax'))
                                            <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control"
                                           value="{{ $contact->email }}" placeholder="e.g. votre@email.ch" required>
                                    @if ($errors->has('email'))
                                        <span class="help-block">
