    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center my-5">
                ...
                <h2 class="text-muted">Ajouter une nouvelle société</h2>
            </div>
            <div class="col-xs-12 col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-block">
                        <h4 class="text-center my-3">Ajouter une société</h4>

                        <div class="col-xs-12 col-xl-8 offset-xl-2">
                            <form method="POST" action="{{ url('/companies') }}" role="form">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                           value="{{ old('name') }}" placeholder="e.g. Pantone" required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <select name="status" id="status" class="custom-select form-control" required>
                                        ...
                                        <option value="temporaire" {{ old('status') == 'temporaire' ? 'selected' : '' }}>Temporaire</option>
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="description" name="description" class="form-control"
                                           value="{{ old('description') }}" placeholder="e.g. Courte description de la société">
