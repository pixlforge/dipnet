<template>
  <div class="col-12 col-lg-6 push-lg-6 fixed-lg-right pr-0">
    <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item bg-red active">
          <div class="carousel-slide carousel-slide-first d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="carousel-slide-content text-center">
              ...
              <p class="description">
                Un moyen facile pour gérer vos fichiers et vos commandes. Groupez et envoyez vos commandes où vous le
                voulez.</p>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item bg-purple">
          <div
            class="carousel-slide carousel-slide-second d-flex flex-column justify-content-center align-items-center">
            <img src="/img/register/macbook.png"
                 alt="MacBook Pro"
                 class="img-carousel mb-5">
            <div class="carousel-slide-content text-center">
              ...
              <p class="description">
                Personnalisez vos commandes de manière individuelle, choisissez le type de papier et la qualité de
                l'impression, lieu de livraison, etc.</p>
            </div>
          </div>
        </div>
